...
| ----- | ----- | ------ |
| 0: Authors/README File | [AUTHORS](https://github.com/AlPascal1010/AirBnB_clone_v2/blob/main/AUTHORS) | Project authors |
| 1: Pep8 | N/A | All code is pep8 compliant|
| 2: Unit Testing | [/tests](https://github.com/AlPascal1010/AirBnB_clone/tree/main/tests) | All class-defining modules are unittested |
...
| 9. More Classes | [/models/user.py](https://github.com/AlPascal1010/AirBnB_clone/blob/main/models/user.py) [/models/place.py](https://github.com/AlPascal1010/AirBnB_clone/blob/dev/models/place.py) [/models/city.py](https://github.com/AlPascal1010/AirBnB_clone/blob/main/models/city.py) [/models/amenity.py](https://github.com/AlPascal1010/AirBnB_clone/blob/dev/models/amenity.py) [/models/state.py](https://github.com/AlPascal1010/AirBnB_clone/blob/main/models/state.py) [/models/review.py](https://github.com/AlPascal1010/AirBnB_clone/blob/dev/models/review.py) | Dynamically implements more classes |
